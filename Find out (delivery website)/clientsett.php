...
try{ 
    ...
    if(isset($_POST['submit'])){
      ...
      $stm -> execute();
      $stm4="UPDATE clientt set image='$image_name' where id=$id";
        $stm=$ddb->prepare($stm4);
        $stm -> execute();
      /* password check statment */
      $stm3="SELECT *from clientt where id=$id";
      $stm=$ddb->prepare($stm3);
      $stm -> execute();
      $dpas=$stm->fetch();
      if($dpas["password"]==$curpass){
        if($newpass==$checkpass){
          $stm4="UPDATE clientt set pass='$newpass' where id=$id";
          $stm=$ddb->prepare($stm4);
          $stm -> execute();
          header("location:clientsett.php");
          }
          else{
             $notvalid2=true;
            }
...
<head>
    ...
    <title> client settings  page </title>
                     ...
                     <div class="logg">
                        ...
                        <form method="post">
                            ...
                            <div class="ne1" style="width: 1000px;">
                               ...
                               <div class="lab"><label class="labin"><em>Email</em><em class="p2" id="aa2"><?=$client['email']?></em></label><label class="btn" id="a2" onclick="show(2,'a2','aa2')">Change</label>
                               ...
                               <div class="lab"><label class="labin"><em>Password</em><em class="p2" id="aa3">***********</em></label><label class="btn" id="a3" onclick="show(3,'a3','aa3')">Change</label>
                                        <div class="hidden" id="3">
                                            <label for="">Current password </label>
                                            <input type="text" name="pass"  class="input1" > <br>
                                            <label for="">New password : </label>
                                            <input type="text" name="pass1"  class="input1" >
                                            <label for="">Confirm password </label>
                                            <input type="text" name="pass2"  class="input1" >
                                            

                                            <input type="submit" class="btn1" value="Update" name="submit" id="btn">
                                        </div>
                                    </div> 
                                    <?php if($notvalid) :?>
                                                  <br>
                                                      <em style="color:red; font-size:1rem ;padding:5px"> The Current password is not valid</em>
                                            <?php  endif; ?>
                                    <?php if($notvalid2) :?>
                                                  <br>
                                                      <em style="color:red; font-size:1rem ;padding:5px"> The Confirmation password is  not match</em>
                                            <?php  endif; ?>
